...
export const SUBJECTS_REGISTRY = [
  ...
  { id: 'FT4474', code: 'FT4474', name: 'Văn hóa ẩm thực', credits: 2, blockId: 'CS_NGANH', semester: 4 },
  { id: 'FT4475', code: 'FT4475', name: 'Tự động hóa trong sản xuất thực phẩm', credits: 2, blockId: 'CS_NGANH', semester: 4 },
  { id: 'FT4476', code: 'FT4476', name: 'Nông nghiệp đạt chuẩn', credits: 2, blockId: 'CS_NGANH', semester: 4 },
  { id: 'FT4477', code: 'FT4477', name: 'Ứng dụng tin học trong CNTP', credits: 2, blockId: 'CS_NGANH', semester: 4 },
  { id: 'FT4469', code: 'FT4469', name: 'Kỹ thuật lạnh', credits: 2, blockId: 'CS_NGANH', semester: 5 },
  { id: 'FT4471', code: 'FT4471', name: 'Tổ chức quản lý doanh nghiệp - CNTP', credits: 2, blockId: 'CS_NGANH', semester: 5 },
  { id: 'FT4472', code: 'FT4472', name: 'Marketing thực phẩm', credits: 2, blockId: 'CS_NGANH', semester: 5 },
  { id: 'FT4473', code: 'FT4473', name: 'Thiết kế bao bì thực phẩm', credits: 2, blockId: 'CS_NGANH', semester: 5 },
  { id: 'FT4478', code: 'FT4478', name: 'Máy và thiết bị trong CNTP', credits: 2, blockId: 'CS_NGANH', semester: 5 },
